...
describe('module contract barrels', () => {
  ...
  it('exposes Hermes composer, prompts, and profiles through lane entrypoints', () => {
    ...
    expect(hermesComposerContract.moveQueuedPrompt).toBeTypeOf('function')
    expect(hermesComposerContract.parseSlashCommand).toBeTypeOf('function')
    expect(hermesComposerContract.recallComposerPromptHistory).toBeTypeOf('function')
  ...
  it('exposes Hermes file contracts through the Hermes files lane', () => {
    ...
    expect(hermesFilesContract.createRemoteDirectory).toBeTypeOf('function')
    expect(hermesFilesContract.deleteRemotePath).toBeTypeOf('function')
    ...
    expect(hermesFilesContract.readRemoteManagedFileDataUrl).toBeTypeOf('function')
    ...
    expect(hermesFilesContract.uploadRemoteFile).toBeTypeOf('function')
    expect(hermesFilesContract.writeRemoteFileDataUrl).toBeTypeOf('function')
  ...
  it('exposes non-Hermes utility barrels through their public entrypoints', () => {
    expect(layoutContract.clampPanelWidth).toBeTypeOf('function')
    expect(layoutContract.installCustomScrollbars).toBeTypeOf('function')
    expect(platformContract.buildAssistantCompleteNotification).toBeTypeOf('function')
