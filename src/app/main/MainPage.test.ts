...
describe('Main dashboard source contract', () => {
  ...
  it('uses the shared Threlte glyph surface, supports personal glyphs, and reflects CPU/RAM load in shape scale', () => {
    ...
    expect(mainGlyphEditDialogSource).toContain('/api/plugins/bitch/glyph/generate')
    expect(mainGlyphEditDialogSource).toContain('/api/plugins/bitch/glyph/list')
    expect(mainGlyphEditDialogSource).toContain('/api/plugins/bitch/glyph/current')
    expect(mainGlyphEditDialogSource).toContain('Generate glyph')
