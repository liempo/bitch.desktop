...
See [`docs/wiki/remote-profile-support.md`](../wiki/remote-profile-support.md) for architecture, config shape, constraints, and validation coverage.
...
See [`docs/wiki/live-thread-preservation.md`](../wiki/live-thread-preservation.md) for the detailed flow and tests.
...
See [`../wiki/hermes-remote-files.md`](../wiki/hermes-remote-files.md) for the resolver contract, denied-path behavior, and
probe checklist.
